  ...
  const submitForm = (event) => {
    ...
    signUp(data)
      ...
      .catch((error) => {
        ...
        console.log("Zerror log", error.response.data.message);
   
        if (error.response) {
          // The API returned an error message
          setError({
            isError: true,
            errors: error.response?.data?.message || "An unknown error occurred",
          });
          toast.error(
   ...
   <Base>
      <div
        style={{
          ...
          alignItems: "center",
          backgroundImage:
            'url("http://localhost:5000/user/image/background.png")',
